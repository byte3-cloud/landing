			...
			<Container>
				<Row>
					<Col lg="4" className="m-b-30">
						...
						<Image src={img1} alt="img" className="img-responsive img-rounded" />
						<p className="m-t-15 m-b-0"></p>
					</Col>
					<Col lg="4" className="text-center m-b-30">
						<h4 className="card-title">Image with circle</h4>
						<h6 className="card-subtitle">
							<code>.img-circle</code> Make sure the image is square not ractangle
						</h6>
					...
					<Col lg="4">
						...
						<Image src={img3} alt="img" className="img-responsive img-thumbnail" />
						<p className="m-t-15 m-b-0"></p>
					</Col>
				</Row>
			</Container>
