    ...
    return (
        <div>
            ...
            <Container>
                <Row>
                    <Col md="12">
                        <Alert color="success">I am an alert and I can be dismissed!</Alert>
                        <Alert color="danger">I am an alert and I can be dismissed!</Alert>
                        <Alert color="warning">I am an alert and I can be dismissed!</Alert>
